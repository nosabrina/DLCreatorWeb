(function(window){
  'use strict';
  /**
   * DL Creator Web v10.04 — configuration runtime publique.
  ...
  const runtimeConfig = Object.freeze({
    ...
    version: 'v10.04',
    numericVersion: '10.04',
    build: '2026.05.12-v10.04-filrouge-image-reorder-pdf-public-cible-10pt-validation-status-import',
    buildIncrement: 204,
