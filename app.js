...
function sectionReorderIcon(direction){
  const arrow = direction < 0
    ? '<path d="M32 11v34M20 23l12-12 12 12" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>'
    : '<path d="M32 11v34M20 33l12 12 12-12" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>';
  return `<svg class="sf-action-icon filrouge-reorder-svg" aria-hidden="true" focusable="false" viewBox="0 0 64 64" data-sf-symbol="arrow.${direction<0?'up':'down'}.document.fill"><path d="M18 6h22l10 10v42H18z" fill="currentColor" opacity=".18"></path><path d="M40 6v12h10" fill="none" stroke="currentColor" stroke-width="4" stroke-linejoin="round" opacity=".55"></path>${arrow}</svg>`;
}
